"""virtualize_22574 URL Configuration
...
admin.site.site_header = "Virtualize"
admin.site.site_title = "Virtualize Admin Portal"
admin.site.index_title = "Virtualize Admin"

# swagger
api_info = openapi.Info(
    title="Virtualize API",
    default_version="v1",
    description="API documentation for Virtualize App",
)
